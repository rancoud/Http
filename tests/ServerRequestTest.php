...
class ServerRequestTest extends TestCase
{
    public function testConstruct(): void
    {
        ...
        static::assertSame('string', (string) $serverRequest->getBody());
    }

    public static function provideNormalizeFilesDataCases(): iterable
    {
        yield 'Single file' => [
            [
                'file' => [
    ...
    #[DataProvider('provideNormalizeFilesDataCases')]
    ...
    public static function provideGetUriFromGlobalsDataCases(): iterable
    {
        $server = [
        ...
        yield 'Empty server variable' => [
            '',
            [],
        ];
    }

    #[DataProvider('provideGetUriFromGlobalsDataCases')]
    ...
    public function testFromGlobals(): void
    {
        ...
        static::assertSame('POST', $server->getMethod());
        static::assertSame(['Host' => ['www.blakesimpson.co.uk']], $server->getHeaders());
        static::assertSame('', (string) $server->getBody());
        static::assertSame('1.0', $server->getProtocolVersion());
        static::assertSame($cookie, $server->getCookieParams());
        static::assertSame($post, $server->getParsedBody());
        static::assertSame($get, $server->getQueryParams());
        ...
        static::assertEqualsCanonicalizing($expectedFiles, $server->getUploadedFiles());
    }
    ...
    public function testAttributes(): void
    {
        ...
        static::assertSame('value', $request2->getAttribute('name'));
        static::assertSame(['name' => 'value'], $request2->getAttributes());
        static::assertSame(['name' => 'value', 'other' => 'otherValue'], $request3->getAttributes());
        static::assertSame(['name' => 'value'], $request4->getAttributes());
    }
